...
public struct TestCalendarView<CalendarCell: View, HeaderCell: View>: View {
    ...
    public init(
        _ controller: CalendarController = CalendarController(), yearMonth: YearMonth,
    ...
    public init(
        ...
        headerSize: HeaderSize = .fixHeight(40), yearMonth: YearMonth, 
...
struct TestCalendarView_Previews: PreviewProvider {
    static var previews: some View {
        TestCalendarView(CalendarController(), yearMonth: YearMonth.current.addMonth(value: 1)) { date in
            GeometryReader { geometry in
