...
public class ModelData: ObservableObject {
    @Published var informations: [Information] = [
        ...
        Information(id: UUID(), title: "Today", color: .blue, date: YearMonthDay(year: 2022, month: 9, day: 16)),
        Information(id: UUID(), title: "Is", color: .blue, date: YearMonthDay(year: 2022, month: 9, day: 16)),
        Information(id: UUID(), title: "Veeeery", color: .blue, date: YearMonthDay(year: 2022, month: 9, day: 16)),
        Information(id: UUID(), title: "Busy", color: .blue, date: YearMonthDay(year: 2022, month: 9, day: 16)),
        Information(id: UUID(), title: "Day", color: .blue, date: YearMonthDay(year: 2022, month: 9, day: 16)),
